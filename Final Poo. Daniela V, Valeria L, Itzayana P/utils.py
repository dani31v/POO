...
inventory_df = pd.read_excel("/Users/danielavalencia/Desktop/parcial2/DB/Inventory.xlsx", sheet_name="Inventory")
# We will read the second sheet of the file, which contains the sales
sales_df = pd.read_excel("/Users/danielavalencia/Desktop/parcial2/DB/Sales.xlsx", sheet_name="Sales")
...
def update_excel():
    ...
    with pd.ExcelWriter("/Users/danielavalencia/Desktop/parcial2/DB/Sales.xlsx") as writer:
        sales_data_frame.to_excel(writer, sheet_name="Sales")

    # Now we save the inventory dataframes in the Excel file
    with pd.ExcelWriter("/Users/danielavalencia/Desktop/parcial2/DB/Inventory.xlsx") as writer:
