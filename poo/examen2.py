...
def addproducts():
    ...
    for i in range (0, option2,1): 
        ...
        codeBar.append(int(input(f"Enter de Bar code of the product  : ")))
        ...
        if sale_Value <= cost:
            print("\033[31mThe sale value is minor or equal than the cost. Please try again.\033[0m")
            sale_Value.append(float(input("Enter the sale value of the product: $ ")))
        ...
        for i in range(len(fechas_convertidas)):
            if fechas_convertidas[i] <= limite:
                print ("\033[31m ERROR. you can't enter an expired product. Please Try again\033[0m ")
...
def sales():
    ...
    for i in range (0, option3):
     ...
     card_cash=(int(input(" 1.Cash \n 2.Card \nEnter an option:")))
     if card_cash == 1:
         card.append(card_cash)
     if card_cash == 2:
         cash.append(card_cash)
